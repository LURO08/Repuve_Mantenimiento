...
\restrict dPRrbLJM7bb3uzYUkaMf3DQWK2ZlorswGUfv0U5cKetvwnWpudxmCWbfURLAQxq
...
COPY public.arcos_bajas (id, arco_id, fecha_baja, motivo, tecnico_responsable, observaciones, created_at, tecnico_id) FROM stdin;
1	45	2026-07-11 08:23:00	Sustitucion de arco	Carlos Serafin Chavelas Gonzalez	Un camión choco contra el poste doblando un poste que sirve como columna de carga del arco quedando inservible y el otro poste de columna tiene un ligero dobles en la base y la estrutura quedando hacia un lado de la hacera	2026-07-11 00:28:09.408493	3
\.
...
COPY public.infraestructura_revisiones (id, infraestructura_id, fecha_mantenimiento, tipo_mantenimiento, observaciones, tecnico_responsable, created_at, tecnico_id) FROM stdin;
4	3	2026-04-25 03:54:00	Correctivo	Se cambio baterias por medio uso	Carlos Serafin Chavelas Gonzalez	2026-05-31 11:55:09	3
\.
...
COPY public.revisiones (id, arco_id, fecha_mantenimiento, tipo_mantenimiento, observaciones, tecnico_responsable, tecnico_id) FROM stdin;
65	31	2026-05-12 13:03:00	Correctivo	Se cambiaron baterias por deterioro 	Carlos Serafin Chavelas Gonzalez	3
67	32	2026-05-07 15:00:00	Correctivo	Se reparo camara LPR Sur Norte y se reparo conecto de luz AC	Carlos Serafin Chavelas Gonzalez	3
70	5	2026-05-25 11:00:00	Correctivo	Se cambiaron las baterias por que ya no retienen carga, comprobado con el tester de baterias	Carlos Serafin Chavelas Gonzalez	3
74	32	2026-05-29 11:14:00	Correctivo	Se cambio el swich uno de la marca hikvision por un wiltek porque ya se bloqueo y dejo de pasar datos de red	Carlos Serafin Chavelas Gonzalez	3
76	32	2025-12-29 04:22:00	Correctivo	Cambio de enlace por daño	Luis Alberto Castro Garcia	2
78	22	2026-04-25 02:19:00	Correctivo	Cambio de baterias por incendio lo que ocaciono que se inflaran las baterias	Carlos Serafin Chavelas Gonzalez	3
79	11	2026-04-25 02:29:00	Correctivo	Cambio de baterias medio uso	Carlos Serafin Chavelas Gonzalez	3
80	38	2026-04-25 02:57:00	Correctivo	Se cambio Cable UTP por que fue cortado	Carlos Serafin Chavelas Gonzolez	1
81	40	2026-03-31 14:11:00	Preventivo	Limpieza de paneles Solares y cambio de baterias 	Carlos Serafin Chavelas Gonzalez	3
82	41	2026-03-31 14:04:00	Preventivo	Cambio de baterias vida util proxima acabar	Carlos Serafin Chavelas Gonzalez	3
83	39	2026-03-30 16:11:00	Correctivo	vestido de arco por daño causado por huracan, 	Carlos Serafin Chavelas Gonzalez	3
84	42	2026-04-21 15:49:00	Correctivo	Cambio de baterias ya no retienen carga	Carlos Serafin Chavelas Gonzalez	3
85	44	2026-04-21 14:40:00	Preventivo	Se cambio baterias y se limpiaron los paneles solared	Carlos Serafin Chavelas Gonzalez	3
86	43	2026-04-21 16:04:00	Preventivo	Se limpiaron los paneles solares y se cambiaron las baterias	Carlos Serafin Chavelas Gonzalez	3
\.
...
SELECT pg_catalog.setval('public.arco_material_id_seq', 767, true);
...
SELECT pg_catalog.setval('public.revision_material_id_seq', 118, true);
...
SELECT pg_catalog.setval('public.revisiones_id_seq', 86, true);
...
\unrestrict dPRrbLJM7bb3uzYUkaMf3DQWK2ZlorswGUfv0U5cKetvwnWpudxmCWbfURLAQxq
